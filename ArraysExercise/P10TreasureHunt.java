        ...
        while (!command.equals("Yohoho!")) {
            ...
            switch (commandParts[0]) {
                ...
                case "Drop":
                    ...
                    break;
                case "Steal":
                    int numbersOfStolenItems = Integer.parseInt(commandParts[1]);
                    if (numbersOfStolenItems >=0 && numbersOfStolenItems < treasureChest.length) {
                        for (int i = 0; i < numbersOfStolenItems; i++) {
                            System.out.print(treasureChest[treasureChest.length - numbersOfStolenItems + i]);
                            if (i != numbersOfStolenItems - 1) {
                                System.out.print(", ");
                            }

                        }
                        String [] tempChest = new String[treasureChest.length - numbersOfStolenItems];
                        for (int i = 0; i < tempChest.length; i++) {
                            tempChest [i] = treasureChest[i];
                        }
                        treasureChest = tempChest;

                    } else if (numbersOfStolenItems >= 0) {
